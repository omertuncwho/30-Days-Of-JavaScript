...
console.log(`Length of the vegetables ${vegetables}`);

console.log(animalProducts);
console.log(`Length of the products ${animalProducts.length}`);

console.log(countries);
console.log(`Length of the fruits ${countries.length}`);

const mixedArray= [3,`Tomato`,4,`Eggs`,1,`Pan`,1,`Stove`];
